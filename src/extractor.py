...
#     """Combines NER and regex extractions."""
#     #  Extract regex fields

#     print("---------------", flush=True)
#     print("Extract field :"+text, flush=True)
...
#     regex_fields = extract_regex_fields(text)
     
#     #  Extract NER fields and map them
#     ner_results = extract_ner_fields(text)
#     ner_fields_list = map_ner_labels(ner_results)

#     # Combine list of dictionaries into a single dictionary
#     ner_fields = {}
#     for field in ner_fields_list:
#         ner_fields.update(field)  # Merging individual dictionaries

#     #  Combine NER and Regex fields
#     combined_fields = {**regex_fields, **ner_fields}
